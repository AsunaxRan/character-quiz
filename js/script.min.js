...
function makeQuiz(){shuffle(quiz_list);for(var a=0;a<total_quiz;a++){var b=[[1,quiz_list[a][1]],[0,quiz_list[a][3][0]],[0,quiz_list[a][3][1]],[0,quiz_list[a][3][2]]];shuffle(b);b='<div class="quiz-item" data-item="'+a+'"><div class="hidden-character"><div class="img-holder"><img data-src="'+img_path+quiz_list[a][2]+'" alt="Hidden character" class="'+(Math.floor(Math.random()*2)==1?"mirror":"")+' lazy img-responsiveY hidden-character-item"></div></div><div class="answers"><div class="option"><button class="btn full-width text-ellipsis answer" data-correct="'+
