...
function openScreen(a){$(".screen").removeClass("open");$(a).addClass("open")}function play(){reset();clean();makeQuiz();openScreen("#in-process");$("#music-bg")[0].volumn=0.7;$("#music-bg")[0].play();nextQuiz()}function counter(a,b){$({Counter:a}).animate({Counter:b},{duration:500,easing:"swing",step:function(){$("#total-point").text(Math.ceil(this.Counter))},complete:function(){$("#total-point").text(b)}})}
...
function nextQuiz(){$(".bonus").removeClass("show");if(current_quiz==total_quiz)endQuiz();else{current_quiz++;current_quiz_item=$(".quiz-item:nth-child("+current_quiz+")");$(".quiz-item").removeClass("show");$(current_quiz_item).addClass("show");$("#current-quiz").text(current_quiz);clearInterval(timer);timing()}}
